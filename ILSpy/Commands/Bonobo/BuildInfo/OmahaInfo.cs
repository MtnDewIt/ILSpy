...
namespace ICSharpCode.ILSpy.Commands.Bonobo.BuildInfo
{
    public class OmahaInfo : IBuildInfo
    {
        ...
        [
            ...
            $"bin\\tools\\bonobo\\Bungie.Asset.dll",
            $"bin\\tools\\bonobo\\Bungie.Blam.dll",
            $"bin\\tools\\bonobo\\Bungie.Core.dll",
            $"bin\\tools\\bonobo\\Bungie.Core.Datastore.dll",
            $"bin\\tools\\bonobo\\Bungie.Core.Wpf.dll",
            $"bin\\tools\\bonobo\\Bungie.Schema.dll",
            $"bin\\tools\\bonobo\\Bungie.Schema.Blam.dll",
            $"bin\\tools\\bonobo\\Bungie.SourceDepot.dll",
            $"bin\\tools\\bonobo\\Bungie.Xbox.dll",
		...
		public void CleanupProjectDump(string project, string outputPath)
		{
			...
			switch (project)
			{
				...
				case $"BonoboPluginSystem":
					...
					break;
				case $"Bungie.Asset":
					CleanupBungieAsset(path);
					break;
				case $"Bungie.Blam":
					CleanupBungieBlam(path);
					break;
				case $"Bungie.Core":
					CleanupBungieCore(path);
					break;
				case $"Bungie.Core.Datastore":
					CleanupBungieCoreDatastore(path);
					break;
				case $"Bungie.Core.Wpf":
					CleanupBungieCoreWpf(path);
					break;
				case $"Bungie.Schema":
					CleanupBungieSchema(path);
					break;
				case $"Bungie.Schema.Blam":
					CleanupBungieSchemaBlam(path);
					break;
				case $"Bungie.SourceDepot":
					CleanupBungieSourceDepot(path);
					break;
				case $"Bungie.Xbox":
					CleanupBungieXbox(path);
					break;
				case $"GuiPlugin":
		...
		public static void CleanupBlamPlugin(string path)
		{
			...
			DirectoryHelper.Rename($"{path}\\TagCustomSection\\QuickPreviewCustomSection.cs", $"{path}\\TagCustomSection\\QuickPreviewCustomSection.xaml.cs");
			DirectoryHelper.Rename($"{path}\\TagCustomSection\\quickpreviewcustomsection.xaml", $"{path}\\TagCustomSection\\QuickPreviewCustomSection.xaml");
		...
		public static void CleanupBungieAsset(string path)
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\Asset", $"{path}");

			Directory.Delete($"{path}\\Bungie", true);
		}

		public static void CleanupBungieBlam(string path)
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\Blam", $"{path}");

			Directory.Delete($"{path}\\Bungie", true);
		}

		public static void CleanupBungieCore(string path)
		{
			//DirectoryHelper.Rename($"{path}\\Bungie\\UI\\WinForms\\InputBoxForm.cs", $"{path}\\Bungie\\UI\\WinForms\\InputBoxForm.Designer.cs");
			//DirectoryHelper.Rename($"{path}\\Bungie\\UI\\WinForms\\ProgressBoxForm.cs", $"{path}\\Bungie\\UI\\WinForms\\ProgressBoxForm.Designer.cs");

			DirectoryHelper.MoveFiles($"{path}\\Bungie.UI.WinForms.InputBoxForm.resx", $"{path}\\Bungie\\UI\\WinForms\\InputBoxForm.resx");
			DirectoryHelper.MoveFiles($"{path}\\Bungie.UI.WinForms.ProgressBoxForm.resx", $"{path}\\Bungie\\UI\\WinForms\\ProgressBoxForm.resx");
		}

		public static void CleanupBungieCoreDatastore(string path)
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie", $"{path}");
		}

		public static void CleanupBungieCoreWpf(string path)
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\UI", $"{path}\\UI");
		...
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\Schema", $"{path}");

			Directory.Delete($"{path}\\Bungie", true);
		}

		public static void CleanupBungieSchemaBlam(string path)
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\Schema\\Blam", $"{path}");

			Directory.Delete($"{path}\\Bungie", true);
		}

		public static void CleanupBungieSourceDepot(string path)
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\SourceDepot", $"{path}");
			DirectoryHelper.Rename($"{path}\\icons", $"{path}\\Icons");

			Directory.Delete($"{path}\\Bungie", true);
		}

		public static void CleanupBungieXbox(string path)
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\Utilities", $"{path}\\Utilities");
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\Xbox", $"{path}\\Xbox");
		...
		public static void CleanupProjectChooser(string path)
		{
			DirectoryHelper.MoveFiles($"{path}\\ProjectChooser", $"{path}");
			DirectoryHelper.Rename($"{path}\\app.config", $"{path}\\App.config");
		...
		{
			DirectoryHelper.MoveFiles($"{path}\\Bungie\\TagWatcher", $"{path}");
			DirectoryHelper.Rename($"{path}\\app.config", $"{path}\\App.config");
